...
const EmailGradientIcon = () => {
  return (
    ...
    >
      ...
      >
        <stop offset="0" stopColor="#8cc5fc"></stop>
        <stop offset="1" stopColor="#d5a8fb"></stop>
      </linearGradient>
      <path
        fill="url(#SVGID_1__l8GURTKU12XE_gr1)"
        d="M18.9,17.8l-3.5-2.5c-1.6-0.7-3.5-0.5-4.8,0.7c-1,1-1.6,2.3-1.6,3.9v3.6l10,7.4V18.5L18.9,17.8L18.9,17.8z"
      ></path>
      <linearGradient
        id="SVGID_2__l8GURTKU12XE_gr2"
        x1="50"
        x2="50"
        y1="16.447"
        y2="24.493"
      ...
      <path
        fill="url(#SVGID_2__l8GURTKU12XE_gr2)"
        d="M55,23.5v-3.6c0-1.5-0.6-2.8-1.6-3.8c0,0,0,0,0,0c-1.5-1.5-3.9-1.5-5.5-0.3l-2.7,2l0,0L45,18.5v12.4L55,23.5z"
      ></path>
      <linearGradient
        id="SVGID_3__l8GURTKU12XE_gr3"
        x1="32"
        x2="32"
        y1="12.957"
        y2="49.383"
